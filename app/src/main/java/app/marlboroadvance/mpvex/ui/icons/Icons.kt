...
object Icons {
  private object Shared {
    ...
    val Cancel = AppIcon(R.drawable.materialsymbols_ic_cancel_rounded_filled)
    val CatchingPokemon = AppIcon(R.drawable.materialsymbols_ic_pets_rounded_filled)
    val Check = AppIcon(R.drawable.materialsymbols_ic_check_rounded_filled)
    ...
    val Clear = AppIcon(R.drawable.materialsymbols_ic_close_rounded_filled)
    val Close = AppIcon(R.drawable.materialsymbols_ic_close_rounded_filled)
